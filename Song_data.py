...
vocal_list = ['洛天依', '乐正绫', '言和', '乐正龙牙', '墨清弦', '徵羽摩柯', '心华', '初音未来', '镜音铃', '镜音连', '巡音流歌', '诗岸', '苍穹', '海伊', '赤羽',
              '艾可', '牧心', '牧馨', 'Minus', '叁琏', '嫣汐', '袅袅', '楚楚', '悦成', '起氏双子', '初音ミク', '起礼', '起复', '东方栀子', '莲华', '幻晓伊',
              '江上曜', '飞梦', '闇音', '天碎瓷']
Translate = {'view': '播放', 'danmaku': '弹幕', 'reply': '评论', 'favorite': '收藏', 'coin': '硬币', 'share': '分享', 'like': '点赞'}
...
class Song:
    ...
    def renew_stat(self):
        res2 = requests.get('https://api.bilibili.com/x/web-interface/view?aid=' + str(aid))
        res2 = json.loads(res2.text)
